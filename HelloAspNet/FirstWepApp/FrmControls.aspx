<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmControls.aspx.cs" Inherits="FirstWepApp.FrmControls" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="BtnOk" runat="server" Text="히든필드 값 출력" OnClick="BtnOk_Click" /><br />

            <asp:HyperLink ID="LnkMicrosoft" runat="server" 
                Text="마이크로소프트" NavigateUrl="https://www.microsoft.com" /><br />
