<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmFileUpload.aspx.cs" Inherits="FirstWepApp.FrmFileUpload" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button runat="server" ID="BtnUpload" Text="업로드" OnClick="BtnUpload_Click" /><br />
